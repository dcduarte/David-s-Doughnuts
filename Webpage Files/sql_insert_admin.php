...
<?php
        ...
        try {
            ...
            $sql = "INSERT INTO users (name, email, password, user_id, user_type, address) VALUES ('$customer_name', '$email', '$passwordadmin', 0 , 'admin', '$address')"; // building a string with the SQL INSERT you want to run
